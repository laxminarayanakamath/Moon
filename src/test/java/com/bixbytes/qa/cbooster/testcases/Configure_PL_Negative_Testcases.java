...
public class Configure_PL_Negative_Testcases extends Base_Main {

	SignInPage signinpage;
	ConfigPage_ProductLevel configpage;
	GeneralAdminLogin generaladminlogin;

	public Configure_PL_Negative_Testcases() {
		super();
	...
	public void tc1_clickadd_withoutdata() throws InterruptedException, Error {
		...
		logger.info("Clicking on add button without entering the product type details");
	}
